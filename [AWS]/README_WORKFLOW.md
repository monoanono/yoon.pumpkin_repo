...
<img width="769" height="338" alt="image" src="https://github.com/user-attachments/assets/aea52fb4-8ce4-47f3-90c3-55005664e2ad" />

### - 개요
### * 컨테이너 이미지 빌드 하여 AWS ECR에 푸시 / ECR 로그인 관련 OIDC 토큰 발행 하여 로그인

# 

### Github Action Workflow.yaml 예시
